...
# jacked from https://raw.githubusercontent.com/moby/buildkit/master/examples/kubernetes/create-certs.sh
# following this https://devopsspiral.com/articles/containers/modernize-image-builds/
