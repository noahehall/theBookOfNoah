...
- backup and torage: manage costs, meet regulatory requirements, reduce latency and save multiple distinct copies of data for compliance requirements
...
- CREATING
  - create a bucket
    - console UI (after clicking bucket name)
      ...
      - metrics
      - management:
        - life cycle rules: define actions to tae during an objects lifetime
